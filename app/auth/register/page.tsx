...
import ActivityCode from "../activity/page"
import { useEmail } from "@/lib/contex/EmailContex"

const formSchema = z.object({
  fullName: z.string().min(2, "Ism kamida 2 harf bo'lishi kerak"),
  email: z.string().email("To'g'ri email kiriting"),
  password: z.string().min(6, "Parol kamida 6 belgidan iborat bo'lishi kerak"),
  role: z.enum(["ADMIN", "USER", "CEMETERY"]),
})
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input  type="password" placeholder="Passwordni kiriting" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
